...
class HalfArcLineDownView(ctx : Context) : View(ctx) {
    ...
    data class HalfArcLineDown(var i : Int) {
    ...
    data class Renderer(var view : HalfArcLineDownView) {

        private val animator : Animator = Animator(view)
        private val hald : HalfArcLineDown = HalfArcLineDown(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : HalfArcLineDownView {
            val view : HalfArcLineDownView = HalfArcLineDownView(activity)
