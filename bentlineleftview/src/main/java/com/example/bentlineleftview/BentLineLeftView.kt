...
fun Canvas.drawBentLineLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawBLLNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawBentLineLeft(scale, w, h, paint)
}

class BentLineLeftView(ctx : Context) : View(ctx) {
    ...
    data class BentLineLeft(var i : Int) {
