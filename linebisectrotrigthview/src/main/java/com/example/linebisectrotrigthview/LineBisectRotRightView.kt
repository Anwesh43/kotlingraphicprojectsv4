package com.example.linebisectrotrigthview
...
fun Canvas.drawLineBisectRotRight(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineBisectRotRightView(ctx : Context) : View(ctx) {
    ...
    data class LineBisectRotRight(var i : Int) {
    ...
    data class Renderer(var view : LineBisectRotRightView) {

        private val animator : Animator = Animator(view)
        private val lbrr : LineBisectRotRight = LineBisectRotRight(0)
    ...
    companion object {
        fun create(activity : Activity) : LineBisectRotRightView {
            val view : LineBisectRotRightView = LineBisectRotRightView(activity)
