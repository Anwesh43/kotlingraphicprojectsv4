package com.example.linesqrotleftview
...
fun Canvas.drawLineSqRotLeft(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLSRLNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineSqRotLeft(scale, w, h, paint)
}

class LineSqRotLeftView(ctx : Context) : View(ctx) {
    ...
    data class LineSqRotLeft(var i : Int) {
