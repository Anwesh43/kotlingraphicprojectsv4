...
class PartialArcToHalfView(ctx : Context) : View(ctx) {
    ...
    data class PartialArcToHalf(var i : Int) {

        private var curr : PATHNode = PATHNode(0)
    ...
    data class Renderer(var view : PartialArcToHalfView) {

        private val path : PartialArcToHalf = PartialArcToHalf(0)
