...
class LineSweepCircleView(ctx : Context) : View(ctx) {
    ...
    data class LineSweepCircle(var i : Int) {

        private var curr : LSCNode = LSCNode(0)
    ...
    companion object {
        fun create(activity : Activity) : LineSweepCircleView {
            val view : LineSweepCircleView = LineSweepCircleView(activity)
