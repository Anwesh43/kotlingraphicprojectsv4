package com.example.lineballrotdownview
...
fun Canvas.drawLineBallRotDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
class LineBallRotDownView(ctx : Context) : View(ctx) {
    ...
    data class LineBallRotDown(var i : Int) {
    ...
    data class Renderer(var view : LineBallRotDownView) {

        private val animator : Animator = Animator(view)
        private val lbrd : LineBallRotDown = LineBallRotDown(0)
