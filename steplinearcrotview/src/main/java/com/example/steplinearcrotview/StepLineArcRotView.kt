package com.example.steplinearcrotview
...
fun Canvas.drawStepLineArcRot(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawSLARNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawStepLineArcRot(scale, w, h, paint)
}

class StepLineArcRotView(ctx : Context) : View(ctx) {
    ...
    data class SLARNode(var i : Int = 0, val state : State = State()) {
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawSLARNode(i, state.scale, paint)
        }
    ...
    data class StepLineArcRot(var i : Int) {
    ...
    companion object {
        ...
        fun create(activity : Activity) : StepLineArcRotView {
            val view : StepLineArcRotView = StepLineArcRotView(activity)
