package com.example.linealtarcdownview
...
fun Canvas.drawLineAltArcDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLAADNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineAltArcDown(scale, w, h, paint)
}

class LineAltArcDownView(ctx : Context) : View(ctx) {
    ...
    data class LAADNode(var i : Int = 0, val state : State = State()) {
    ...
    data class LineAltArcDown(var i : Int) {
