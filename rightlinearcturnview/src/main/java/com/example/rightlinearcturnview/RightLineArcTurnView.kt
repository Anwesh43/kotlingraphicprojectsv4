package com.example.rightlinearcturnview
...
fun Canvas.drawRightLineArcTurn(scale : Float, w : Float, h : Float, paint : Paint) {
...
class RightLineArcTurnView(ctx : Context) : View(ctx) {
    ...
    data class RightLineArcTurn(var i : Int) {

        private var curr : RLATNode = RLATNode(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : RightLineArcTurnView {
            val view : RightLineArcTurnView = RightLineArcTurnView(activity)
