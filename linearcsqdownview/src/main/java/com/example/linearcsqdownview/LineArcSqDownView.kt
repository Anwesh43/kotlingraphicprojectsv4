package com.example.linearcsqdownview
...
fun Canvas.drawLineArcSqDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLASDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineArcSqDown(scale, w, h, paint)
}

class LineArcSqDownView(ctx : Context) : View(ctx) {
