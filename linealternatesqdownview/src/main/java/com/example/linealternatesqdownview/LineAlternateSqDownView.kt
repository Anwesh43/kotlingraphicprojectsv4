package com.example.linealternatesqdownview
...
fun Canvas.drawLineAlternateSqDown(scale : Float, w : Float, h : Float, paint : Paint) {
...
fun Canvas.drawLASDNode(i : Int, scale : Float, paint : Paint) {
    ...
    drawLineAlternateSqDown(scale, w, h, paint)
}
