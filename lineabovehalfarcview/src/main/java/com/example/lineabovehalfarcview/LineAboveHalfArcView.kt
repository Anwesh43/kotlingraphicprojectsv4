...
class LineAboveHalfArcView(ctx : Context) : View(ctx) {
    ...
    data class LAHANode(var i : Int = 0, val state : State = State()) {

        private var next : LAHANode? = null
        private var prev : LAHANode? = null
        ...
        fun draw(canvas : Canvas, paint : Paint) {
            canvas.drawLAHANode(i, state.scale, paint)
        }
        ...
        fun getNext(dir : Int, cb : () -> Unit) : LAHANode {
            var curr : LAHANode? = prev
            if (dir == 1) {
                curr = next
            }
            if (curr != null) {
    ...
    data class LineAboveHalfArc(var i : Int) {

        private var curr : LAHANode = LAHANode(0)
    ...
    companion object {
        ...
        fun create(activity: Activity) : LineAboveHalfArcView {
            val view : LineAboveHalfArcView = LineAboveHalfArcView(activity)
