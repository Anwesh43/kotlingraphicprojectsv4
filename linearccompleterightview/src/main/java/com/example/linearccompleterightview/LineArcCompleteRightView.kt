...
class LineArcCompleteRightView(ctx : Context) : View(ctx) {
    ...
    data class Renderer(var view : LineArcCompleteRightView) {

        private val animator : Animator = Animator(view)
        private val lacr : LineArcCompleteRight = LineArcCompleteRight(0)
    ...
    companion object {
        ...
        fun create(activity : Activity) : LineArcCompleteRightView {
            val view : LineArcCompleteRightView = LineArcCompleteRightView(activity)
